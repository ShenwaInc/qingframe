...
class HttpService
{
    ...
    public static function ihttp_socketopen($hostname, $port = 80, &$errno=0, &$errstr='', $timeout = 15) {
        $fp = '';
    ...
    public static function ihttp_email($to, $subject, $body, $global = false) {
        set_time_limit(0);
