                ...
                <div class="layui-card-body">
                    <form class="layui-form" method="post" action="{{ wurl('setting/blacklist') }}">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label">@lang('IP黑名单')</label>
                            <div class="layui-input-block">
                                <textarea class="layui-textarea" rows="20" name="blacklist">{!! $Blacklist !!}</textarea>
                                <p class="layui-word-aux">@lang('每行一个IP')</p>
                                <p class="layui-word-aux">@lang('支持配置通配符*，例如：192.168.* (每行仅限一个通配符，且必须放在最后)')</p>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-input-block">
