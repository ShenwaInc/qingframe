            ...
            <div class="layui-card-body">
                <form class="layui-form" action="{{ $_W['siteurl'] }}" method="post">
                    ...
                    <div class="layui-form-item must">
                        <label class="layui-form-label">第三方入口</label>
                        <div class="layui-input-block">
                            ...
                            <div class="layui-word-aux">
                                第三方入口链接需要符合单点登录的规范，<a href="https://www.yuque.com/shenwa/tt5ahr/co6qmcz2kicd9wms" class="text-blue" target="_blank">查看详情</a>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            ...
                            <input type="radio" name="data[openType]" value="iframe" title="iFrame" {{ $configs['openType']=='iframe' ? 'checked' : '' }} />
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
