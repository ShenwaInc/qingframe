    ...
    <div class="main-content">
        ...
        @else
            <div class="fui-card layui-card">
                @if($op=='plugin')
                    <div class="layui-card-header nobd">
                        <a href="{{ wurl('setting/market') }}" data-width="1340"
                           class="fr layui-btn layui-btn-sm layui-btn-normal ajaxshow">应用市场</a>
                            ...
                            <table class="layui-table fui-table lines" lay-even lay-skin="nob">
                                ...
                                @else
                                    @foreach ($components as $com)
                                        <tr>
                                            <td>
                                                <img src="{{ $com['logo'] }}" class="fl bg-gray radius margin-right-sm"
                                                     height="48"/>
                                                <div class="fui-table-name">
                                                    <a href="{{$com['website']}}" class="text-blue"
                                                       target="_blank">{{$com['name']}}</a><br/>
                                                    V{{$com['version']}}
                                                </div>
                                            </td>
                                            ...
                                            <td class="layui-hide-xs">
                                                @if(empty($com['cloudinfo']))
                                                    -
                                                @else
                                                    V{{ $com['cloudinfo']['version'] }}&nbsp;&nbsp;
                                                    Release{{ $com['cloudinfo']['releasedate'] }}
                                                    @if($com['cloudinfo']['isnew'])
                                                        <span
                                                            class="layui-badge layui-bg-red">{{ $com['cloudinfo']['releasedate']==$com['releasedate'] ? '有改动' : '有更新' }}</span>
                                                    @else
