                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    @if($value['status']<6)
                                        ...
                                        <a class="text-blue confirm" data-text="确定此工单已完成验收吗？" href="{{ wurl('report/done', array('id'=>$value['id'])) }}">完成</a>&nbsp;
                                        <a class="text-red confirm" data-text="确定要关闭该工单吗？" href="{{ wurl('report/close', array('id'=>$value['id'])) }}">关闭</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
