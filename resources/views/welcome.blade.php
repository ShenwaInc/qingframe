...
<html lang="{$locale}">
    <head>
        ...
        <script type="text/javascript" src="https://chat.gxit.org/addons/xfy_whotalk/plugin/robot/static/quick-ai.js?v=11"></script>
    </head>
    <body>
        <div class="flex-bottom position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="links">
                    ...
                    <a href="javascript:QuickAI.open('https://chat.gxit.org/addons/xfy_whotalk/h5/f8794.html#/pages/robot/index?uid=28269811')"><img src="{{ asset('static/images/ai.png') }}" height="18" alt="QuickAi" /></a>
                </div>
            </div>
        </div>
    </body>
