...
function mc_update($uid, $fields) {
	...
	$cachekey = CacheService::system_key('memberinfo', array('uid' => $uid));
...
function mc_handsel($touid, $fromuid, $handsel, $uniacid = '') {
	...
	$creditbehaviors = unserialize($creditbehaviors) ? unserialize($creditbehaviors) : array();
