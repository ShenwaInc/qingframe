...
<script>
	...
	export default {
		...
		data() {
			return {
				verifyImgs:[{
					src:core.system.siteroot+'/addons/xfy_whotalk/static/verify/0.jpg',
					color:'#38a7b7'
				},{
					src:core.system.siteroot+'/addons/xfy_whotalk/static/verify/1.jpg',
					color:'#485967'
				},{
					src:core.system.siteroot+'/addons/xfy_whotalk/static/bg_album.jpg',
					color:'#fab33e'
				}],
				verifyIndex:0,
				canvasW:"",
